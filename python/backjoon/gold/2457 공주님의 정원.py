...
# if n == 1:
#     l = L.pop()
#     if l[0]<3 or (l[0] == 3 and l[1] == 1) and l[2] == 2:
#         print(1)
#     else:
#         print(0)
#     exit()
...
#     i = 0
#     while i < len(L):
#         if L[i][0] == L[i][2] and L[i][1] == L[i][3]:
#             L.remove(L[i])
#             break
#         elif L[i][0] > L[i][2] or (L[i][0] == L[i][2] and L[i][1] > L[i][3]):
#             L.remove(L[i])
#             break
#         if L[i][0] < l[2] or (L[i][0] == l[2] and L[i][1] <= l[3]):
#             if L[i][2] > l[2] or (L[i][2] == l[2] and L[i][3] >= l[3]):
#                 count += 1
#                 l = L[i]
#                 L.pop(i)
#                 stack = 0
