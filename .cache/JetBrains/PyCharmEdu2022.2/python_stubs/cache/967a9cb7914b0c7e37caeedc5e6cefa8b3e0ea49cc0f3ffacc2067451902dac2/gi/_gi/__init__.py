# encoding: utf-8
# module gi._gi
# from /usr/lib/python3/dist-packages/gi/_gi.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
TYPE_GSTRING = None # (!) real value is '<GType GString (30676000)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f2864531c20>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f2864531800>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2864540890>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f2864540890>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-311-x86_64-linux-gnu.so')"
