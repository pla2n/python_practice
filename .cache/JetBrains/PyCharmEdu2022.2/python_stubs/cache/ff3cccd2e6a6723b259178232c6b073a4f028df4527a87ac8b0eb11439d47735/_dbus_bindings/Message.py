...
class Message(object):
    ...
    def get_allow_interactive_authorization(self, bool): # real signature unknown; restored from __doc__
        """
    ...
    def set_allow_interactive_authorization(self, bool): # real signature unknown; restored from __doc__
        """
