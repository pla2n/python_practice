...
# from /usr/lib/python3/dist-packages/systemd/_daemon.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
"""
...
def _listen_fds_with_names(unset_environment=True): # real signature unknown; restored from __doc__
    """
...
__spec__ = None # (!) real value is "ModuleSpec(name='systemd._daemon', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28646ea2d0>, origin='/usr/lib/python3/dist-packages/systemd/_daemon.cpython-311-x86_64-linux-gnu.so')"
