...
# from /usr/lib/python3/dist-packages/systemd/login.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28646f0090>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd.login', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28646f0090>, origin='/usr/lib/python3/dist-packages/systemd/login.cpython-311-x86_64-linux-gnu.so')"
