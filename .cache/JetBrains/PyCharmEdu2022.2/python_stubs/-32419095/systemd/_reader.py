...
# from /usr/lib/python3/dist-packages/systemd/_reader.cpython-311-x86_64-linux-gnu.so
# by generator 1.147
...
class _Reader(object):
    ...
    def _get_end(self, *args, **kwargs): # real signature unknown
        """
        get_end() -> int
    ...
    def _get_start(self, *args, **kwargs): # real signature unknown
        """
        get_start() -> int
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28646f0290>'

__spec__ = None # (!) real value is "ModuleSpec(name='systemd._reader', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f28646f0290>, origin='/usr/lib/python3/dist-packages/systemd/_reader.cpython-311-x86_64-linux-gnu.so')"
